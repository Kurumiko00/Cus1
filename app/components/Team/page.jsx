  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
       {/* คณะจัดทำงานเกี่ยวกับการพัฒนาเว็ปแอพพิเคชั่นด้วย NextJS ซี่งสมาชิกจำทำดังนี้ */}
      </p>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            นายนนท์ปวิธ โคตรธรรม
            </h2>
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540204143</h3>
            <p className="mb-4">
            Position: CEO
            </p>
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540204408</h3>
            <p className="mb-4">
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            <h2 className="title-font font-medium text-lg text-white">
            นางสาวนันทิตา ไชยยงค์
            </h2>
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540201677</h3>
            <p className="mb-4">
            Position: CFO
            </p>
            <span className="inline-flex">
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            <h3 className="text-white mb-3">รหัสพนักงาน :  6540201339</h3>
            <p className="mb-4">
            Position: HR Manager
            </p>
            <span className="inline-flex">
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540200752</h3>
            <p className="mb-4">
            Position: Software Network Developer
            </p>
            <span className="inline-flex">
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            <h2 className="title-font font-medium text-lg text-white">
            นายดนุเดช โชติขจรวงศ์
            </h2>
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540201081</h3>
            <p className="mb-4">
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540203384</h3>
            <p className="mb-4">
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540200695</h3>
            <p className="mb-4">
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540205710</h3>
            <p className="mb-4">
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            <h3 className="text-white mb-3">รหัสพนักงาน : 6540201370</h3>
            <p className="mb-4">
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        ...
        <span className="ml-3 text-xl">หลักสูตรภาษาอังกฤษ
        </span>
      </a>
