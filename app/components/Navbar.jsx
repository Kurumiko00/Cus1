      ...
      <header className="text-white body-font bg-gray-800">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-600 flex flex-wrap items-center text-base justify-center">
            <a href="http://localhost:3000/" className="mr-5 hover:text-gray-300">
              Home
            </a>
            <a href="http://localhost:3000/components/Project/" className="mr-5 hover:text-gray-300">
              Project
            </a>
            <a href="http://localhost:3000/components/Team" className="mr-5 hover:text-gray-300">
              Team
            </a>
            <a href="http://localhost:3000/components/Contact" className="mr-5 hover:text-gray-300">
              Contact
            </a>
          </nav>
        </div>
